...
- [Capítulo VIII: Experiment-Driven Development](#capítulo-viii-experiment-driven-development)
  ...
  - [8.2. Experiment Design](#82-experiment-design)
    ...
    - [8.2.7. Web and Mobile Tracking Plan.](#827-web-and-mobile-tracking-plan)  - [8.3. Experimentation](#83-experimentation)
...
|--------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **1. Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de TI.** | **John**:<br>• TB1: Apoyó en el análisis del problema y arquitectura inicial.<br>• TP: Participó en la definición de requerimientos técnicos y modelado de base de datos.<br>• TB2: Colaboró en pruebas de base de datos y mejoras del backend.<br><br>**Michael**:<br>• TB1: Investigó tecnologías frontend.<br>• TP: Implementó UI con React y Tailwind.<br>• TB2: Refinó prototipos e integró componentes.<br><br>**Rodrigo**:<br>• TB1: Apoyó en la validación de entrevistas y necesidades.<br>• TP: Colaboró en diseño de wireframes.<br>• TB2: Participó en implementación de interfaz.<br><br>**Fabian**:<br>• TB1: Participó en definición de hipótesis y backlog inicial.<br>• TP: Estructuró cuestionamientos experimentales.<br>• TB2: Apoyó en estructura lógica del backend.<br><br>**Alessandro**:<br>• TB1: Redactó documentación técnica y de usuario.<br>• TP: Diseñó User Personas y Empathy Maps.<br>• TB2: Refinó mockups y análisis visual. | **TB1:** El equipo actualizó conceptos clave sobre gestión ágil, levantamiento de necesidades y análisis de problemas reales. Se fortalecieron habilidades en documentación y arquitectura base.<br><br>**TP:** Los miembros profundizaron conocimientos técnicos específicos (React, base de datos, UX), vinculando teoría con práctica mediante desarrollo de componentes funcionales y diseño de solución centrada en el usuario.<br><br>**TB2:** Se consolidaron conocimientos aplicados, reforzando dominio técnico en integración, validación de solución y experiencia de usuario. El equipo aplicó estándares más altos de calidad técnica. |
| **2. Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de TI.**  | **John**:<br>• TB1: Estudió nuevas herramientas de bases de datos.<br>• TP: Se capacitó en modelado relacional y queries SQL.<br>• TB2: Adaptó sus conocimientos para ajustes técnicos del backend.<br><br>**Michael**:<br>• TB1: Exploró nuevas librerías de UI.<br>• TP: Aprendió sobre responsive design y accesibilidad.<br>• TB2: Investigó mejoras en experiencia de usuario para tareas.<br><br>**Rodrigo**:<br>• TB1: Asimiló conceptos de diseño UI.<br>• TP: Practicó creación de flujos visuales.<br>• TB2: Participó en pruebas de interfaz con usuarios.<br><br>**Fabian**:<br>• TB1: Profundizó en Lean UX y validación de hipótesis.<br>• TP: Lideró la planificación de experimentación.<br>• TB2: Aplicó análisis y reflexionó sobre métricas aprendidas.<br><br>**Alessandro**:<br>• TB1: Investiga tendencias en diseño UX/UI.<br>• TP: Aprendió herramientas de prototipado (Figma).<br>• TB2: Evaluó y mejoró criterios de accesibilidad visual. | **TB1:** Todos los integrantes asumieron la necesidad de aprender nuevas herramientas y enfoques para abordar el proyecto, especialmente en relación con metodologías ágiles y fundamentos de UX.<br><br>**TP:** Se intensificó la autoformación, con cada miembro asumiendo la mejora constante como parte clave del desarrollo del producto, evidenciando compromiso por crecer profesionalmente.<br><br>**TB2:** La experiencia adquirida fue puesta a prueba en implementación y validación. Se identificaron oportunidades de mejora continua y cada miembro fortaleció su disposición a seguir aprendiendo.                                                                                                                                                  |
...
| Story ID | Título                                   |
|----------|-------------------------------------------|
| US-08    | Creación de User Stories                  |
| US-09    | Modificación de User Stories              |
| US-10    | Eliminación de User Stories              |
| US-24    | Estimación de Esfuerzo en User Stories    |
| US-11    | Creación de User Epics                    |
| US-12    | Modificación de User Epics                |
| US-13    | Eliminación de User Epics                 |
| US-14    | Creación de Tasks                         |
| US-15    | Modificación de Tasks                     |
| US-16    | Eliminación de Tasks                      |

# Epic 03: Gestión de artefactos

| Story ID | Título                                   |
|----------|-------------------------------------------|
| US-17 - 18    | Visualización del Product Backlog         |
...
| Story ID | Título                                   |
|----------|-------------------------------------------|
| US-21    | Ver Información de Usuario de los Miembros |
| US-22    | Asignar Roles a los Miembros del Equipo   |
| US-23 | Conocer Información del Perfil de un Miembro |
| US-25    | Sign In |
| US-26    | Sign Up |
| US-27 | Seguridad de la cuenta |
...
| Story ID | Título |
|----------|-|
| TS001   | Configurar Entorno de Desarrollo para ManageWise Horizon   |
| TS002    | Endpoint para visualizar Miembros del equipo|
| TS003    | Endpoint para eliminacion de miembro|
| TS004    | Endpoint para creación de User Stories en el Backlog|
| TS005    | Endpoint para modificación de User Stories |
| TS006    | Endpoint para sign up|
| TS007    | Endpoint para sign in|
...
| 8 | US08|Creación de user stories | Como Product Owner, quiero poder crear user stories dentro del backlog para detallar funcionalidades específicas que el equipo de desarrollo pueda implementar. | 5 |
| 09 | US09|Modificación de user stories | Como Product Owner, quiero poder editar las user stories existentes para modificar su descripción, criterios de aceptación o prioridad según los cambios del proyecto. | 3 |
| 10 | US10|Eliminación de user stories | Como Product Owner, quiero poder eliminar user stories que ya no sean relevantes o necesarias para mantener el backlog limpio. |3 |
| 11 | US11|Creación de user epics | Como Product Owner, quiero poder crear epics para agrupar funcionalidades grandes y organizarlas dentro del backlog. |2 |
| 12 | US12|Modificación de user epics | Como Product Owner, quiero poder editar las epics existentes para ajustar su descripción, criterios de éxito o desglosarlas en nuevas user stories. |2|
| 13 | US13|Eliminación de user epics | Como Product Owner, quiero poder eliminar epics que ya no sean relevantes o que hayan sido completadas para mantener el backlog organizado. |2 |
| 14 | US14|Creación de tasks | Como Product Owner, quiero poder crear tasks para así informar a los desarrolladores sobre esta y en caso sea necesario relacionarla a una user story. | 3|
| 15 | US15|Modificación de tasks | Como Product Owner, quiero poder editar las tasks asociadas a una user story para actualizar detalles técnicos o modificar el estado de la tarea. |3 |
| 16 | US16|Eliminación de tasks | Como Product Owner, quiero poder eliminar tasks completadas o irrelevantes para mantener el backlog de tareas organizado. | 2 |
| 17 | US17|Vista centrada en backlog items | Como usuario, quiero una vista centrada en los backlog items para poder gestionar de manera eficiente las epics, user stories y tasks. |2 |
| 18 | US18|Visualización del product backlog | Como usuario, quiero poder visualizar todos los items del product backlog para tener una visión clara de las épicas, user stories y tasks pendientes. | 3 |
| 19 | US19|Asignación de backlog items a un sprint. Como Product Owner, quiero poder asignar backlog items a un sprint para planificar el trabajo que se va a realizar durante el sprint. | 5|
| 20| US20 | Gestión de sprints | Como Scrum Master, quiero poder gestionar los sprints para poder crear, editar o finalizar sprints según sea necesario durante el ciclo de desarrollo. | 5|
| 21| US21|Ver la información de usuario de los miembros| Como Scrum Master, Quiero conocer la información de usuario de cada miembro del equipo de desarrollo,Para identificar habilidades técnicas y blandas que faciliten la asignación de roles (como Product Owner, Scrum Master o miembros del equipo de desarrollo), la formación de grupos y la asignación de su líder la toma de decisiones en tareas específicas.| 2|
| 22 | US22 |Asignar roles a los miembros del equipo | Como Scrum Master, Quiero asignar roles específicos de la metodología SCRUM para cada miembro del equipo, Para asegurar una colaboración efectiva y un enfoque claro en las responsabilidades. | 3 |
| 23 | US23|Conocer Información del Perfil de un Miembro | Como Scrum Master, Quiero poder acceder al perfil completo de un miembro del equipo, Para conocer mejor a mis colegas y fomentar relaciones interpersonales más fuertes. |3 |
| 24| US24|Estimación de Esfuerzo en User Stories | Como Desarrollador, quiero ver la estimación de esfuerzo asociada a cada User Story, para gestionar mejor el tiempo y recursos del equipo. | 5 |
| 25 | US26|Sign In | Como miembro del equipo, quiero poder iniciar sesion en la aplicacion con una cuenta ya creada, para asi tener acceso a todos los recursos. | 3 |
| 26 | US26|Sign up | Como miembro del equipo, quiero poder crear una cuenta en la plataforma, para de esta forma poder guardar datos importante y acceder al inicio de sesión. | 3 |
| 27 | US27 | Seguridad de la cuenta | Como usuario, quiero que mi cuenta esté protegida mediante protocolos de seguridad, para asegurar que solo yo pueda acceder a mis datos y recursos. | 3 |
| 28 | TS001   | Configurar Entorno de Desarrollo para ManageWise Horizon   |
| 29    | TS002          | Endpoint para visualizar Miembros del equipo | Crear un endpoint que permita visualizar todos los miembros.    | 3                 |
| 30     | TS003          | Endpoint para eliminacion de miembro | Crear un endpoint que permita eliminar a un miembro especifico.  | 5                               |
| 31     | TS004          | Endpoint para creación de User Stories en el Backlog | Crear un endpoint para permitir la creación de nuevas User Stories.            | 3                               |
| 32     | TS005          | Endpoint para modificación de User Stories         | Crear un endpoint que permita modificar User Stories existentes.                | 3                               |
| 33     | TS006          | Endpoint para sign up         | Crear un endpoint que permita crear una nueva cuenta.                | 5                               |
| 34     | TS007          | Endpoint para sign in         | Crear un endpoint que permita iniciar sesión validando si existe la cuenta ingresada.                | 5                               |
...
[![Backlog-Service-Test.png](https://i.postimg.cc/g0NxNTT2/Backlog-Service-Test.png)](https://postimg.cc/5HQ9tnJh)

**Iam Service Test**
[![Iam-Service-Test.png](https://i.postimg.cc/jqJzSR16/Iam-Service-Test.png)](https://postimg.cc/bdpG6fpd)
**Issues Service Test**
[![Issues-Service-Test.png](https://i.postimg.cc/kGdD4PVw/Issues-Service-Test.png)](https://postimg.cc/qhjpbYxC)

**Meeting Service Test**
[![Meeting-Service-Test.png](https://i.postimg.cc/J0c0HYZ8/Meeting-Service-Test.png)](https://postimg.cc/rRsMvJfZ)

**Members Service Test**
[![Members-Service-Test.png](https://i.postimg.cc/c40rGZGL/Members-Service-Test.png)](https://postimg.cc/NLCgR303)
...
![](/assets/images/CoreSystemTests/US01.PNG)
...
![](/assets/images/CoreSystemTests/US02.PNG)
...
![](/assets/images/CoreSystemTests/US03.PNG)
...
![](/assets/images/CoreSystemTests/US04.PNG)
...
![](/assets/images/CoreSystemTests/US05.PNG)
...
![](/assets/images/CoreSystemTests/US06.PNG)
...
![](/assets/images/CoreSystemTests/US07.PNG)
...
![](/assets/images/CoreSystemTests/US08.PNG)
...
![](/assets/images/CoreSystemTests/US09.PNG)
...
![](/assets/images/CoreSystemTests/US10.PNG)
...
![](/assets/images/CoreSystemTests/US11.PNG)
...
![](/assets/images/CoreSystemTests/US12.PNG)
...
![](/assets/images/CoreSystemTests/US13.PNG)
...
![](/assets/images/CoreSystemTests/US14.PNG)
...
![](/assets/images/CoreSystemTests/US15.PNG)
...
![](/assets/images/CoreSystemTests/US16.PNG)
...
![](/assets/images/CoreSystemTests/US17.PNG)
...
![](/assets/images/CoreSystemTests/US18.PNG)
...
![](/assets/images/CoreSystemTests/US19.PNG)
...
![](/assets/images/CoreSystemTests/US20.PNG)
...
![](/assets/images/CoreSystemTests/US27.PNG)
...
![](/assets/images/CoreSystemTests/US28.PNG)
...
![](/assets/images/CoreSystemTests/US29.PNG)
...
![](/assets/images/CoreSystemTests/US43.PNG)
...
![](/assets/images/CoreSystemTests/US44.PNG)
